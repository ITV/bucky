...
import com.rabbitmq.client.{Channel, Command, ConfirmListener, Connection, Consumer, FlowListener, GetResponse, Method, ReturnListener, ShutdownListener, ShutdownSignalException, BasicProperties => _}
