...
package object test {
  ...
  object TestAmqpClient {
    def forgivingSimulator[F[_]](
        config: AmqpClientConfig)(implicit F: ConcurrentEffect[F], t: Timer[F], cs: ContextShift[F]): Resource[F, AmqpClient[F]] =
      AmqpClient.apply[F](
        config,
